/*
  ...
  gengetopt --input=getopt.conf --include-getopt 
...
const char *gengetopt_args_info_purpose = "Calculates math expressions";

const char *gengetopt_args_info_usage = "Usage: \n$ calc -e (1+2)-(-3)\n6\n\n$ echo '(1+2)-(-3)\n(3.)/(2)' > a.txt\n$ calc -f a.txt\n6\n1.500000000\n\n$ echo '(1+2)-(-3)' | calc -l\n6.000000000\n";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --filename=STRING    Parse expression from file.",
  "  -e, --expression=STRING  Calculate this expression.",
  "  -l, --float              Calculates all in floats.  (default=off)",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->expression_arg = NULL;
  args_info->expression_orig = NULL;
  args_info->float_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->expression_help = gengetopt_args_info_help[4] ;
  args_info->float_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->expression_arg));
  free_string_field (&(args_info->expression_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->expression_given)
    write_into_file(outfile, "expression", args_info->expression_orig, 0);
  if (args_info->float_given)
    write_into_file(outfile, "float", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvf:e:l", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* Increase program verbosity..  */
          ...
          break;
        case 'f':	/* Parse expression from file..  */
          ...
          break;
        case 'e':	/* Calculate this expression..  */
        
        
          if (update_arg( (void *)&(args_info->expression_arg), 
               &(args_info->expression_orig), &(args_info->expression_given),
              &(local_args_info.expression_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "expression", 'e',
              additional_error))
            goto failure;
          ...
          break;
        case 'l':	/* Calculates all in floats..  */
        
        
          if (update_arg((void *)&(args_info->float_flag), 0, &(args_info->float_given),
              &(local_args_info.float_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "float", 'l',
              additional_error))
            goto failure;
